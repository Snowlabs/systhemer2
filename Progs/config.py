...
class ConfigElement(object):
    ...
    def build_hierarchy_tree(self):
        ...
        logger.log(common.Settings.VDEBUG, 'tree generated: %s', self.tree)
        logger.log(common.Settings.VDEBUG, 'simplified tree: %s',
...
class RuleTree(ConfigElement):
    ...
    def build_leaves_list(self):
        ...
        self.logger.log(common.Settings.VDEBUG, 'leaves list generated: %s',
                        self.leaves)
        return self.leaves
